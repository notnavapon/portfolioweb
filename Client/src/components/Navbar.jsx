          ...
          <div className="flex items-center gap-2">
            ...
            {authUser && (
              <>
                ...
                <Link to={"/chat"} className="btn btn-sm gap-2 rounded-md shadow-lg">
                  <MessageCircleMore />
                  <span className="hidden sm:inline">Chat wc</span>
                </Link>

                <Link to={"/profile"} className="btn btn-sm gap-2 rounded-md shadow-lg">
                  <User className="size-5" />
                  <span className="hidden sm:inline">Profile</span>
                </Link>

                <Link onClick={logout} className="btn btn-sm gap-2 rounded-md shadow-lg">
                  <User className="size-5" />
